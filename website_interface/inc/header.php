                        ...
                        <div class="wp-inner">
                            ...
                            <div id="main-menu-wp" class="fl-right">
                                <ul id="main-menu" class="clearfix">
                                    ...
                                    <li>
                                        <a href="?mod=product&act=main&cat_id=1" title="">Sản phẩm</a>
                                    </li>
                                    <li>
                                        <a href="?mod=post&act=main" title="">Tin tức</a>
                                    </li>
                                    <li>
                                        <a href="?mod=pag&act=detail&id=1" title="">Giới thiệu</a>
                                    </li>
                                    <li>
                                        <a href="?mod=pag&act=detail&id=2" title="">Liên hệ</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="wp-inner">
                            ...
                            <div id="action-wp" class="fl-right">
                                <div id="advisory-wp" class="fl-left">
                                    ...
                                    <span class="phone">0569.969.101</span>
                                </div>
